...
WebUI.click(findTestObject('warehouseConfigurationPage/actionsMenu'))

WebUI.mouseOver(findTestObject('warehouseConfigurationPage/archiveSetting'))

WebUI.click(findTestObject('warehouseConfigurationPage/archiveSetting'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('warehouseConfigurationPage/archiveButton'))
